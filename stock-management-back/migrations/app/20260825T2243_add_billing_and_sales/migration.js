...
import { Migration, MigrationCLI, checkExpression, col, fn, primaryKey, } from '@prisma/orm-postgres/migration';
export default class M extends Migration {
    startContractJson = startContract;
    ...
    get operations() {
        return [
            this.createTable({
                ...
                constraints: [
                    primaryKey(['id']),
                    checkExpression('paymentOrder_status_check_fc16580c', "\"status\" IN ('pending', 'approved', 'rejected', 'cancelled')"),
                ],
            }),
            this.createTable({
                schema: 'public',
