...
export type StorageHash =
  StorageHashBase<'9feeddf211bc3245c8522b8e0d542d287bcb8bcfaa14f0b5ef98a51fcf73a291'>;
export type ExecutionHash =
  ExecutionHashBase<'08d13e78dfebaa278a4d20c5f4f95649f16df8fd3223783ca8e0951b659bfb38'>;
...
export type FieldOutputTypes = {
  readonly public: {
    ...
    readonly PasswordResetToken: {
      ...
      readonly usedAt: CodecTypes['pg/timestamptz@1']['output'] | null;
      readonly createdAt: CodecTypes['pg/timestamptz@1']['output'];
    };
    readonly PaymentOrder: {
      ...
      readonly mercadopagoPreferenceId: CodecTypes['pg/text@1']['output'] | null;
      readonly mercadopagoPaymentId: CodecTypes['pg/text@1']['output'] | null;
      readonly createdAt: CodecTypes['pg/timestamptz@1']['output'];
      readonly updatedAt: CodecTypes['pg/timestamptz@1']['output'];
    };
    readonly Product: {
...
export type FieldInputTypes = {
  readonly public: {
    ...
    readonly PasswordResetToken: {
      ...
      readonly usedAt: CodecTypes['pg/timestamptz@1']['input'] | null;
      readonly createdAt: CodecTypes['pg/timestamptz@1']['input'];
    };
    readonly PaymentOrder: {
      readonly id: CodecTypes['pg/int4@1']['input'];
      ...
      readonly status: 'pending' | 'approved' | 'rejected' | 'cancelled';
      readonly mercadopagoPreferenceId: CodecTypes['pg/text@1']['input'] | null;
      readonly mercadopagoPaymentId: CodecTypes['pg/text@1']['input'] | null;
      readonly createdAt: CodecTypes['pg/timestamptz@1']['input'];
      readonly updatedAt: CodecTypes['pg/timestamptz@1']['input'];
    };
    readonly Product: {
          ...
          readonly table: {
            ...
            readonly paymentOrder: {
              columns: {
                ...
                readonly mercadopagoPreferenceId: {
                  readonly nativeType: 'text';
                  readonly codecId: 'pg/text@1';
                  readonly nullable: true;
                };
                readonly mercadopagoPaymentId: {
                  readonly nativeType: 'text';
                  readonly codecId: 'pg/text@1';
                  readonly nullable: true;
                };
              ...
              indexes: readonly [
                {
                  readonly name: 'paymentOrder_tenantId_idx_c93ed4f1';
                  readonly prefix: 'paymentOrder_tenantId_idx';
                  readonly columns: readonly ['tenantId'];
                  readonly unique: false;
                },
              ];
            ...
            readonly sale: {
              ...
              indexes: readonly [
                {
                  readonly name: 'sale_tenantId_idx_c93ed4f1';
                  readonly prefix: 'sale_tenantId_idx';
                  readonly columns: readonly ['tenantId'];
                  readonly unique: false;
                },
                {
                  readonly name: 'sale_productId_idx_5858600a';
                  readonly prefix: 'sale_productId_idx';
          ...
          readonly PaymentOrder: {
            ...
            readonly storage: {
              ...
              readonly fields: {
                ...
                readonly mercadopagoPreferenceId: { readonly column: 'mercadopagoPreferenceId' };
                readonly mercadopagoPaymentId: { readonly column: 'mercadopagoPaymentId' };
                readonly createdAt: { readonly column: 'createdAt' };
                readonly updatedAt: { readonly column: 'updatedAt' };
              };
            };
